...
class Result {
    ...
    public static List<Integer> circularArrayRotation(List<Integer> list, int rotations, List<Integer> queries) {
        List<Integer> result = new ArrayList();        
        
        for (int index : queries) {
            result.add(list.get((list.size() + index - rotations % list.size()) % list.size()));
        }
